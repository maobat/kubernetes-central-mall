...
Implement a **Blue-Green [Deployment](../../../../GLOSSARY.md#deployment)** strategy. You will learn how to run two full environments in parallel and perform an instant cutover using a Kubernetes [Service](../../../../GLOSSARY.md#service).

> **CKAD Importance:** High. Understanding how Services route traffic based on labels is a core requirement for mastering [deployment](../../../../GLOSSARY.md#deployment) patterns like Blue-Green and Canary.

---

## 🛍️ Mall Analogy

In the **Central Mall**, a **Blue-Green [Deployment](../../../../GLOSSARY.md#deployment)** is like building a brand new shop (**Green**) right next to the old one (**Blue**). 
...
| **[Service](../../../../GLOSSARY.md#service) Selector** | The "Main Entrance" sign points to the new location. |
...
1. **Blue (v1):** Already running ([Deployment](../../../../GLOSSARY.md#deployment) `wonderful-v1`, image `httpd:alpine`).
2. **Green (v2):** Create a new [Deployment](../../../../GLOSSARY.md#deployment) `wonderful-v2` with `nginx:alpine` and 4 replicas.
3. **The Switch:** Update the selector of the `wonderful` [Service](../../../../GLOSSARY.md#service) to point to the `v2` version.
...
### 3. Flip the Switch
Once the new pods are `Running`, update the [Service](../../../../GLOSSARY.md#service):
...
- **Isolation by Labels:** The `version` label is the key. Without it, the [Service](../../../../GLOSSARY.md#service) would route traffic to both versions simultaneously.
- **Instant Rollback:** If v2 fails, simply edit the [Service](../../../../GLOSSARY.md#service) and change the selector back to `version: v1`.
