# 🧪 LAB 02: The Side Entrance (NodePort & Multi-[Namespace](../../../../GLOSSARY.md#namespace))
...
This lab focuses on **[Service](../../../../GLOSSARY.md#service) exposure** and **cross-[namespace](../../../../GLOSSARY.md#namespace) communication**. You will learn how to expose a shop to the outside world using a **NodePort** and how workers in different "wings" (Namespaces) can still talk to each other using the Full Qualified Domain Name (FQDN).

> **CKAD Importance:** Very High. NodePort is the standard way to expose services in many exam tasks, and multi-[namespace](../../../../GLOSSARY.md#namespace) connectivity is a frequent troubleshooting topic.
...
- **The New Wing ([Namespace](../../../../GLOSSARY.md#namespace): remote)** → A separate area with its own staff and rules.
- **The Boutique ([Pod](../../../../GLOSSARY.md#pod): remoteweb)** → The shop itself, hidden deep in the `remote` wing.
...
| **[Namespace](../../../../GLOSSARY.md#namespace)** | A distinct wing of the mall. |
...
1. **[Namespace](../../../../GLOSSARY.md#namespace)**: Create a wing named `remote`.
2. **Shop**: Run `remoteweb` (nginx) inside the `remote` [namespace](../../../../GLOSSARY.md#namespace).
3. **Entrance**: Expose it on the exterior wall using **NodePort 31999**.
4. **Intercom**: Verify that a worker in the `default` [namespace](../../../../GLOSSARY.md#namespace) can reach it.
...
### 3. Test the Long Intercom (Cross-[Namespace](../../../../GLOSSARY.md#namespace))
```bash
...
- **Port vs TargetPort vs NodePort:**
  - `port`: Exposed on the [Service](../../../../GLOSSARY.md#service).
