...
This chapter covers patterns for running multiple containers within a single [Pod](../../../GLOSSARY.md#pod) and managing shared or persistent storage.

| Lab Name | Description |
| --- | --- |
| [Lab 01: Sidecar Pattern](./lab01-sidecar-pattern/README.md) | Learn how to use a [sidecar container](../../../GLOSSARY.md#sidecar-container) to extend the functionality of a main application. |
