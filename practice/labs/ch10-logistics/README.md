...
Manage application packages and deployments using Helm and other Kubernetes tools.

| Lab Name | Description |
| --- | --- |
| [Lab 01: Helm Audit](./lab01-helm-audit/README.md) | Audit existing Helm releases and their status in the cluster. |
| [Lab 02: Helm & Kustomize](./lab02-helm-kustomize/README.md) | Understand the use cases for Helm and Kustomize in package management. |
