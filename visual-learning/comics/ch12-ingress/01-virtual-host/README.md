...
- **Lab** → [Ingress Virtual Hosts](../../../../practice/labs/ch12-ingress/lab03-advanced-ingress/README.md)
- **Docs** → [Managing Ingress Resources](../../../../reference/md-resources/ingress-vs-gateway.md)
