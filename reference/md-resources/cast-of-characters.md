...
| **The Day-Use Locker** | **emptyDir** | The Shift Workspace | **(Storage)** Temporary space shared between workers in the *same* shop (Pod). If the shop closes, the locker is emptied and wiped clean. |
