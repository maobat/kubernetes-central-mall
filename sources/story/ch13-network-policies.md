...
In a busy mall, not everyone should be allowed everywhere. You don't want a customer from the "Pet Store" accidentally wandering into the "Jewelry Vault," nor do you want a rival "Pizza Shop" employee spying on the [secret](../../GLOSSARY.md#secret) recipe of the "Burger Joint." To prevent this, the Mall Owner installs **Locked Corridors**.
...
- **[Ingress](../../GLOSSARY.md#ingress) Rules:** Who is allowed to *enter* my shop? (e.g., "Only the [Ingress](../../GLOSSARY.md#ingress) entrance and the Inventory app can talk to me.")
