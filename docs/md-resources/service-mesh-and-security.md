...
<img src="images/service-mesh-architecture.png" alt="Service Mesh and Security" height="35%" width="35%" />
...
<img src="images/observability-control-room.png" alt="Observability (The Mall Control Room)" height="35%" width="35%" />
...
- 1. **Prometheus & Grafana:** The **Metric Gauges**. Prometheus collects the numbers (the "scrapers"), and Grafana puts them on beautiful TV screens in the control room.<img src="images/data-warehouse-architecture.png" alt="Data Warehouse Architecture" height="35%" width="35%" />
