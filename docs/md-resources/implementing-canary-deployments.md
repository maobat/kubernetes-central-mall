...
<img src="images/canary-deployment-schema.png" alt="Canary Deployment Schema in Kubernetes" height="35%" width="35%" />

<img src="images/gateway-traffic-flow.png" alt="The 'Smart Transit Hub'" height="35%" width="35%" />
