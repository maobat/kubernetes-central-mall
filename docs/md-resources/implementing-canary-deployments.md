...
<img src="../images/image-10.png" alt="Canary Deployment Schema in Kubernetes" height="35%" width="35%" />

<img src="../images/image13.png" alt="The 'Smart Transit Hub'" height="35%" width="35%" />
